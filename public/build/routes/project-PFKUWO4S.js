import "/build/_shared/chunk-7RZFFSMX.js";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1708584838770.5898";
}
function FormProject() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("form", { className: "flex flex-col items-start gap-y-6", method: "post", action: "/project", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "flex justify-center gap-4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { className: "rounded-md bg-transparent border", type: "text", id: "project_name", name: "project_name" }, void 0, false, {
        fileName: "app/components/form.jsx",
        lineNumber: 25,
        columnNumber: 17
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { className: "flex w-[450px] justify-center rounded-md bg-white text-gray-600 font-bold border border-gray-600 p-3", children: "Simpan" }, void 0, false, {
      fileName: "app/components/form.jsx",
      lineNumber: 31,
      columnNumber: 13
    }, this)
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1708514500739.69";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1708597984640.413";
}
function Poject() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-col w-screen h-screen p-6 gap-y-8 overflow-x-hidden", children: [
...
//# sourceMappingURL=/build/routes/project-PFKUWO4S.js.map
